...
public class JavaApplication1 extends Application{
    ...
    Label option2InstructorLocation;
  ...
  public void start(Stage primaryStage) throws FileNotFoundException{
    ...
    ArrayList<String> departmentLocation = new ArrayList<String>();
      ...
      Location2 = new TextField();
      Location2.setPrefWidth(80);
      Location2.setMaxWidth(80);
      ...
      button2.setOnAction((ActionEvent event) -> {
          primaryStage.setScene(option1);
          option2layout.getChildren().add(ID2);
          option1layout.getChildren().add(Dept2);
          option1layout.getChildren().add(Location2);
          option1layout.getChildren().add(returnButton);
    });
      //submitButtonOption2(){
       // String strID = ID2.getText();
       // String stdDept = Dept2.getText();
       // String strLocation = Location2.getText();
